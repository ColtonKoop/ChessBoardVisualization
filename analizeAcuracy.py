...
def plotHistory(history, location):
    """
    Plot the history over the epochs of the runs.
    """
...
def generateClassifcationReport(model, test_gen, location):
    """
    Generates the confussion matrix MCC scores and F1 scores fo the test data
    """
...
if __name__ == "__main__":
    # the name of the run to be analized located in ./RunData
