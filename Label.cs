...
public class Label
{
    ...
    public Label()
    {
        ...
        this.id = Storage.boardNumber.ToString();
        Storage.boardNumber++;
        this.randomStrategy = (Board.RandomStrategy)rnd.Next(1);
        //this.lightRotation = RandomVector(LightRotationMin, LightRotationMax);
        //122.9377	160.9463	137.3297
        this.lightRotation = new Vector3(122.9377f, 160.9463f, 137.3297f); //specify the light angle  
        //this.lookAtPoint = RandomVector(LookAtPointMin, LookAtPointMax);
        this.lookAtPoint = new Vector3(0f,-5f, 0f); //specify the point the camera is looking at
        //this.cameraPoint = RandomVector(CameraPointMin, CameraPointMax);
        this.cameraPoint = new Vector3(0f, 25f, 15f); //specify camera position
        ...
        this.boardSet = BoardSets[0]; //specify board style
        this.pieceSet = PieceSets[1]; //specify piece style
